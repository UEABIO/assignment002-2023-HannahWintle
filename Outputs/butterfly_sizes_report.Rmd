---
title: "Exploring the universal ecological responses to climate change in butterflies"
...
One possible explanation for this sexual dimorphism in size is the role of [fecundity\@blanckenhorn2007](mailto:fecundity@blanckenhorn2007){.email}. In many butterfly species, females carry the responsibility of egg production, requiring more energy and resources for [reproduction\@wiklund1993](mailto:reproduction@wiklund1993){.email}. Larger body size in females may provide an advantage in terms of reproductive success by allowing for greater egg production and potentially increasing offspring [rates\@bissoondath1997](mailto:rates@bissoondath1997){.email}.
